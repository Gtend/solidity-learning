...
//  - reward sources : 1 MT/block minting
...
contract TinyBank is MultiManagedAccess{
    ...
    constructor(IMyToken _stakingToken, address[5] memory _managers) MultiManagedAccess(msg.sender, _managers) {
        stakingToken = _stakingToken;
        rewardPerBlock = defaultRewardPerBlock;
    }

    // genesis staking 시 totalStaked, staked[to] 0 방지
